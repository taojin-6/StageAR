...
class LidarReconstruction:
    def __init__(self):
        self.metadata = None
        self.is_done = False
        self.cloud = o3d.t.geometry.PointCloud()
    ...
    def integrate(self, voxel_grid, point_cloud, range_img):
        frustum_block_coords = voxel_grid.compute_unique_block_coordinates(point_cloud, settings.trunc_voxel_multiplier)
    ...
    def lidar_reconstruction(self, point_cloud, range_img):
        ...
        for i in range(settings.num_integrate_frame):
